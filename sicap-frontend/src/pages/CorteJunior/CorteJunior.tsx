...
const CorteJunior: React.FC = () => {
  ...
  const handleValidar = () => {
    ...
    alert(
      `Corte del cobrador ${corteSeleccionado?.cobrador} validado con: ${archivoValidacion.name}`,
    );
    handleCerrarPopup();
  };
      ...
      <div className="cdc-card">
        ...
        <div className="cdc-select-wrapper cdc-full-width">
          ...
          >
            ...
            <option value="1">Gustavo Hernandez</option>
            <option value="2">Adolfo Martínez</option>
          </select>
