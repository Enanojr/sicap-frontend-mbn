...
export default function RegisterColonia() {
  ...
  const validateForm = (): FormErrors => {
    ...
    if (!formData.nombre_colonia.trim()) {
      newErrors.nombre_colonia= "La colonia es requerida";
    }
        ...
        <div className="register-form-container-sector">
          <div className="register-form-grid">
            ...
            <div className="form-field">
              ...
              {errors.nombre_colonia && (
                <span className="form-error">{errors.nombre_colonia}</span>
              )}
            </div>
            ...
            <div className="form-field">
              ...
              {errors.codigo_postal && (
                <span className="form-error">{errors.codigo_postal}</span>
              )}
            </div>
          </div>
          ...
          <div className="form-actions">
            ...
            <Botones onClick={handleSubmit} disabled={loading}>
              {loading ? "Registrando..." : "Registrar Colonia"}
            </Botones>
          </div>
        </div>
      </div>
